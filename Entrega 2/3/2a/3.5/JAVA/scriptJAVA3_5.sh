...
do
echo "--------------------------------------------" >> ./tiempoJAVA3_5.txt
echo "tamaño de la entrada $size" >> ./tiempoJAVA3_5.txt
echo "--------------------------------------------" >> ./tiempoJAVA3_5.txt
...
vagrant ssh vm2 -c "cd /vagrant; java Client.java $ip $port $size >> /vagrant/tiempoJAVA3_5.txt"
done
done
