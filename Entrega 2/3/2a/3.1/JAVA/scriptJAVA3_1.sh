...
do
echo "--------------------------------------------" >> ./tiempoJAVA3_1.txt
echo "tamaño de la entrada $size" >> ./tiempoJAVA3_1.txt
echo "--------------------------------------------" >> ./tiempoJAVA3_1.txt
...
vagrant ssh vm2 -c "cd /vagrant; java Client.java $ip $port $size >> /vagrant/tiempoJAVA3_1.txt"
done
done
